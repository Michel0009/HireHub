...
import { baseURL, editCV, headers } from "../../../Api/Api";
...
const EditCV= () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(response.data.message==="Your CV updated Succefully"){
    ...
    <section className="w-full">
      <div className="usercontainerr">
        <Card className="w-full ">
          <CardHeader>
            <CardTitle style={{ fontWeight: "bold" }}>Edit Your CV</CardTitle>
            <CardDescription>
              Fill out the form below to Edit your CV.
            </CardDescription>
          </CardHeader>
